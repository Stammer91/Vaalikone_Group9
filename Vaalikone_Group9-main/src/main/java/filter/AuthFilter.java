...
@WebFilter(dispatcherTypes = {
		...
		, urlPatterns = {"/redirect"})//Which URI's come through this filter
public class AuthFilter implements Filter {
	/*
	 * Attribute valiUsers, where the credentials of the valid users are added.
	 * A better way would be to use database
	 */
	...
	public void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (!allowUser(auth)) {
            ...
            // The client is allowed to forward the request to the URI "/redirect"
	...
	public void getUser() {
        ...
        validUsers.put("samu:vaalikonesm","authorized");
        validUsers.put("oskari:vaalikoneos","authorized");
        validUsers.put("henri:vaalikonehi","authorized");
	}
